...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PB0T0FS\\TESTDB;Initial Catalog=Makets;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Page>(entity =>
            {
                ...
                entity.Property(e => e.MateKey).HasMaxLength(250);
        ...
        public DbSet<WebBanDongHo.ModelViews.RegisterViewModel>? RegisterViewModel { get; set; }

        public DbSet<WebBanDongHo.ModelViews.LoginViewModel>? LoginViewModel { get; set; }

        public DbSet<WebBanDongHo.ModelViews.ChangePasswordViewModel>? ChangePasswordViewModel { get; set; }
    }
}
